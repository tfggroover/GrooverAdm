...
namespace GrooverAdm.Business.Services.User
{
    public interface IUserService
    {
        ...
        Task<IEnumerable<Entities.Application.ListableUser>> GetOwners(IEnumerable<string> references);
        Task<Entities.Application.ListableUser> NameAdmin(string userId, string user);
